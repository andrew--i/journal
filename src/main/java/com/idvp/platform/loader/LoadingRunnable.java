...
import com.idvp.platform.collector.BufferingLogDataCollectorProxy;
import com.idvp.platform.collector.LogDataCollector;
import com.idvp.platform.configuration.LogCollectorConfiguration;
import com.idvp.platform.importer.LogImporter;
import com.idvp.platform.io.LoadingInfo;
import com.idvp.platform.io.ObservableInputStreamImpl;
import com.idvp.platform.io.Utils;
import com.idvp.platform.loading.LoadStatistic;
import com.idvp.platform.loading.SocketSource;
...
public class LoadingRunnable implements Runnable {
    ...
    private void runWithSocket(SocketSource source) {
        ...
        try {
            ...
            final LogCollectorConfiguration configuration = new LogCollectorConfiguration();
            configuration.setProperty(LogCollectorConfiguration.TAILING_PANEL_PLAY, true);
            ...
            while (parsingContext.isParsingInProgress()) {
                try {
                    ...
                    synchronized (this) {
                        ...
                        obserableInputStreamImpl.ifPresent(in -> in.getCurrentRead());
